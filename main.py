...
if __name__ == "__main__":
    ...
    anpr = ANPR(model_path="models/anpr_best.pt")  # Use trained YOLO license plate model
    anpr.infer_video(source="data/test2.mp4", output_path="test_output4.mp4", display=True)
